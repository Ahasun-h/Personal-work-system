...
<!-- Start:Title -->
@section('title','Income | Deposit Add')
<!-- End:Title -->
        ...
        <div class="row">
            ...
            <!-- End:Alert -->
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('income-or-deposit.store') }}" method="post">
                            <div class="row">
                                @csrf
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" value="{{ old('amount') }}" placeholder="0.00" min="0" >

                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <select id="transaction_type" class="form-control" disabled>
                                    ...
                                    <option value="1" {{ $transaction->transaction_type == 1 ? 'selected' : '' }} >Withdraw</option>
                                    <option value="5" {{ $transaction->transaction_type == 5 ? 'selected' : '' }} >Expense</option>
                                </select>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Example" value="{{ $transaction->title }}" readonly>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 mb-3">
                                ...
                                <select id="transaction_method" class="form-control" disabled>
                                    ...
                                    <option value="2" {{ $transaction->transaction_method == 2 ? 'selected' : '' }} >Bank</option>
                                </select>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 mb-3">

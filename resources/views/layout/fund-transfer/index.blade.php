            ...
            <!-- End:Alert -->
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-content-center">
                        ...
                        <a href="{{ route('fund-transfer.create') }}" type="button" class="btn btn-sm btn-primary text-white">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{route('fund-transfer.index')}}",
                    type: "get"
                },
                columns: [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                    {data: 'account_in', name: 'account_in', orderable: true, searchable: true},
                    {data: 'account_out', name: 'account_out', orderable: true, searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("fund-transfer.destroy",":id") }}';
            $.ajax({
                type: "DELETE",

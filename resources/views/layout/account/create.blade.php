                        ...
                        <form action="{{ route('account.store') }}" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <select name="branch_id" id="branch_id" class="form-control">
                                        ...
                                        @foreach($branchs as $branch)
                                            <option value="{{ $branch->id }}" >{{ $branch->branch_name }} | {{ $branch->bank->bank_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="account_number" placeholder="Example" name="account_number" value="{{ old('account_number') }}">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="account_holder_name" placeholder="Example" name="account_holder_name" value="{{ old('account_holder_name') }}">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="amount" placeholder="0.00" min="0" name="amount" value="{{ old('amount') }}">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cheque_number" placeholder="Example" name="cheque_number" value="{{ old('cheque_number') }}">

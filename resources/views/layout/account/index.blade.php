            ...
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-content-center">
                        ...
                        <a href="{{ route('account.create') }}" type="button" class="btn btn-sm btn-primary text-white">
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'account_holder_name', name: 'account_holder_name', orderable: true, searchable: true},
                    ...
                    {data: 'default_account', name: 'default_account', orderable: true, searchable: true},
        ...
        // Default Account Set Change Confirm Alert
        function showDefaultAccountSetAlert(id) {
            event.preventDefault();
            swal({
                title: `Are you sure?`,
                text: "You want to update the status?.",
                ...
                if (willStatusChange) {
                    defaultAccountChange(id);
                }
            });
        };

        // Status Change
        function defaultAccountChange(id) {
            var url = '{{ route("account.default-account-update",":id") }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function (resp) {
